...
//	public static List listApp;
	...
	// Class Instance Data:
	private LinkedList<Patient> patientLinkedList = new LinkedList<Patient>();
	...
	public PatientForm() {
		...
		cmbDoctor.setModel(new DefaultComboBoxModel(new String[] {"Dr. Ivan Rebick", "Dr. Joshua Rusko", "Dr. Waylon Urps"}));
		cmbDoctor.setBounds(174, 186, 157, 20);
		getContentPane().add(cmbDoctor);
		
		JDateChooser dateChooserAppointmentDate = new JDateChooser();
		...
		listAppointments.setBounds(39, 348, 292, 127);
		...
		cmbHour.setModel(new DefaultComboBoxModel(new String[] {"08.00am", "08.30am", "09.00am", "09.30am", "10.00am", "10.30am", "11.00am", "11.30am", "12.00pm", "12.30pm", "01.00pm", "01.30pm", "02.00pm", "02.30pm", "03.00pm", "03.30pm", "04.00pm", "04.30pm", "05.00pm", "05.30pm"}));
		cmbHour.setBounds(174, 262, 157, 18);
		getContentPane().add(cmbHour);
//		if(dateChooserAppointmentDate)
		System.out.println(cmbHour.getItemAt(0));
		
		boolean isAfternoon = false;
		if(cmbHour.getSelectedIndex() < 7) isAfternoon = true;
		if(isAfternoon) {
			System.out.println("afternoon");
		}
		else if(!isAfternoon) System.out.println("morning");
